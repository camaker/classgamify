...
activity authoring, AI enhancement lifecycle review, assignment publish,
student runner, scored attempts, submitted-date continuity, accepted-answer
continuity, explanation continuity, teacher result review, copy/export/print
handoffs, dashboard/public entry alignment, or privacy guards.
