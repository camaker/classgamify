import type { PublicTemplateEntryHandoffView } from '@/activities/entry-page-view';
import { Badge } from '@/components/ui/badge';

type PublicTemplateEntryHandoffPanelProps = {
  view: PublicTemplateEntryHandoffView;
};

export function PublicTemplateEntryHandoffPanel({
  view,
}: PublicTemplateEntryHandoffPanelProps) {
  const titleId = 'public-template-entry-handoff-title';
  const descriptionId = 'public-template-entry-handoff-description';
