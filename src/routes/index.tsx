  ...
  const introCopy =
    currentLocale === 'zh'
      ? {
          ...
          freeBadge: '3 个入门汉字',
          title: '从三个高频汉字开始练习',
          worksheetNote: getTrialWorksheetNote('zh'),
        }
      : {
          ...
          worksheetNote: getTrialWorksheetNote('en'),
        };

  return (
    <HanziPracticePage
      initialCharacter={TRIAL_WORKFLOW_CHARACTERS[0]}
      initialCharacters={[...TRIAL_WORKFLOW_CHARACTERS]}
      introCopy={introCopy}
    />
  );
}
