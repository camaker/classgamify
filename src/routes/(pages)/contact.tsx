  ...
  return (
    <Container className="px-4 py-12 md:py-16">
      <div className="mx-auto max-w-6xl space-y-8 pb-16">
        <section
          aria-label={pageView.hero.ariaLabel}
        ...
        <section
          aria-label={pageView.topicSection.ariaLabel}
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(340px,420px)]">
          <div className="space-y-4">
            ...
            <section
              aria-label={pageView.checklist.ariaLabel}
            ...
            <div className="grid gap-4">
              {mailto ? (
                <article
                  aria-label={pageView.supportEmail.ariaLabel}
                  className="min-w-0"
                >
                  <a
                    aria-label={pageView.supportEmail.actionAriaLabel}
                    href={mailto}
                    className="block rounded-lg border bg-card p-5 transition-colors hover:border-primary/40 hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  >
        ...
        {mailto ? (
          <div className="flex justify-center">
            <a
              ...
              aria-label={pageView.supportCta.ariaLabel}
            >
              <IconMailFilled className="size-4" />
              {pageView.supportCta.label}
            </a>
          </div>
        ) : null}
      </div>
...
function SupportTopicCard({
  ...
  return (
    <a
      aria-label={topic.actionAriaLabel}
      href={href}
